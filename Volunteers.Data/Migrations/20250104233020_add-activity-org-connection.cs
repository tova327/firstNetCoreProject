...
{
    public partial class addactivityorgconnection : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VolunteerInActivities_Activities_ActivityId",
                        column: x => x.ActivityId,
                        principalTable: "Activities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VolunteerInActivities_Users_VolunteerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orgs_ManagerId",
                table: "Orgs",
                column: "ManagerId");

            migrationBuilder.CreateIndex(
                name: "IX_VolunteerInActivities_ActivityId",
                table: "VolunteerInActivities",
                column: "ActivityId");

            migrationBuilder.CreateIndex(
                name: "IX_VolunteerInActivities_VolunteerId",
                table: "VolunteerInActivities",
                column: "VolunteerId");
        }
